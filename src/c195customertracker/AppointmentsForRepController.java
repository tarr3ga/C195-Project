 ...
 * @author jamyers
 */
public class AppointmentsForRepController implements Initializable {
@FXML private TableView appointmentsTable;
        ...
        appointmentsTable.setOnMouseClicked((MouseEvent event) -> {
            if(event.getClickCount() >= 2) {
                ...
                try {                    
                    ...
                    Logger.getLogger(AppointmentsForRepController.class.getName()).log(Level.SEVERE, null, ex);
                }      
            }       
        });
    ...
    public void initialize(URL url, ResourceBundle rb) {        
        try {
            FetchData data = new FetchData();
            appointments = data.fetchAppointmentsForCustomerRep(rep);
        } catch(SQLException ex) {
            System.err.println(ex.toString());
        } catch (ClassNotFoundException ex) {
        Logger.getLogger(AppointmentsForRepController.class.getName()).log(Level.SEVERE, null, ex);
